# -*- coding: utf-8 -*-
#==========================================================================#
# Description: FMCW RADAR RANGE Processing                                 #
...
def range_resolution_max_distance(configs):
    """ Calculate the range resolution and maximum distance for the given radar configuration
    ...
    range_resolution = configs.LIGHT_SPEED / (2.0 * (configs.end_frequency_Hz - configs.start_frequency_Hz))
    max_distance = range_resolution * configs.num_samples_per_chirp / 2

    return range_resolution, max_distance


def range_processing(adc_data, n_fft=None, window_type_1d=None, axis=-1):
    ...
    radar_cube = np.fft.fft(fft1d_in, n=n_fft, axis=axis)
